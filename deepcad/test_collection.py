...
class testing_class():
    ...
    def prepare_file(self):
        ...
        self.output_path = self.output_dir + '//' + current_time + '_ModelFolderIs_' + self.denoise_model  # + 'DataFolderIs_' + self.datasets_name + '_'
    ...
    def test(self):
        ...
        for pth_index in range(len(self.model_list)):
            ...
            if '.pth' in aaa:
                ...
                # load model
                model_name = self.pth_dir + '//' + pth_name  # + '//' + self.denoise_model
                ...
                for N in range(len(self.img_list)):
                    ...
                    if (self.save_test_images_per_epoch):
                        ...
                        feature_name = output_path_name + '//' + 'feature.pth'
